...
* [Embedding](https://github.com/novnc/noVNC/tree/master/docs/EMBEDDING.md) - For the noVNC application
* [Library](https://github.com/novnc/noVNC/tree/master/docs/LIBRARY.md) - For the noVNC JavaScript library


### Authors/Contributors

See [AUTHORS](https://github.com/novnc/noVNC/tree/master/AUTHORS) for a (full-ish) list of authors.  If you're not on
